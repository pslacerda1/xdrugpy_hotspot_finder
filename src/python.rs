...
use pyo3::prelude::*;
use crate::{Hotspot, Cluster, HotspotClass, find_hotspots, write_pdbstr};
...
#[pymethods]
impl PyCluster {
    #[getter] pub fn title(&self) -> String { self.0.get_title() }
    #[getter] pub fn strength(&self) -> u32 { self.0.get_strength() }
    ...
    pub fn __repr__(&self) -> String {
        format!("Cluster(title={:?}, strength={})", self.0.title, self.0.strength)
    }
}
...
#[pymethods]
impl PyHotspot {
    #[getter] pub fn class(&self) -> PyHotspotClass { self.0.get_class().into() }
    #[getter] pub fn strength_total(&self) -> u32 { self.0.get_strength_total() }
    #[getter] pub fn strength_0(&self) -> u32 { self.0.get_strength_0() }
    #[getter] pub fn strength_1(&self) -> Option<u32> { self.0.get_strength_1() }
    #[getter] pub fn strength_z(&self) -> Option<u32> { self.0.get_strength_z() }
    #[getter] pub fn max_distance(&self) -> f32 { self.0.get_max_distance() }
    #[getter] pub fn centroid_distance(&self) -> Option<f32> { self.0.get_centroid_distance() }

    #[getter]
    pub fn clusters(&self) -> Vec<PyCluster> {
        self.0.clusters.iter().map(|c| PyCluster(c.clone())).collect()
    }
    ...
    pub fn __repr__(&self) -> String {
        format!(
            ...
            self.0.class, self.0.strength_total, self.0.clusters.len()
        )
    }
}
...
pub fn py_find_hotspots(
    ...
    let (clusters, hotspots) = find_hotspots(
        pdb_str, clash_threshold, num_pseudoatoms, pseudoatom_radius, deep_search,
